                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-0">
                            ...
                            <div class="py-3 w-auto  d-flex  align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Tabel Stock Barang </h6>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered mr-auto" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                    $stocknya = mysqli_query($conn, "SELECT * FROM stock WHERE stock < 1");
                                    while ($fech = mysqli_fetch_array($stocknya)) {
                                        $barang = $fech['namabarang'];

                                    ?>
                                        <div class="alert alert-danger">
                                            <strong>Perhatian!</strong> Stock Barang <?= $barang; ?> Habis!.
                                        </div>
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="edit" name="updatebarang" class="btn btn-primary">Edit</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="hapusbarang" class="btn btn-danger">Yes</button>
